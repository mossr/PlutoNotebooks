...
# ╔═╡ a29113e1-a6f7-47b5-a7c5-df7b3738824d
using GLMakie

# ╔═╡ 9cfd4f03-87e8-41fe-b4da-e8561bfd7c66
md"""
# Pumpkin
Modified from the following MATLAB 280 character code:
- [https://github.com/zappo2/digital-art-with-matlab/blob/master/pumpkin/punkin280.m](https://github.com/zappo2/digital-art-with-matlab/blob/master/pumpkin/punkin280.m)

Note, descriptions of the code come from the comments of that file. Credit due to [@zappo2](https://github.com/zappo2).
"""

# ╔═╡ e1d06e20-42a6-4aa8-a244-e4e4052d912e
function sphere(n)
...
# ╔═╡ 825033f7-529e-4f1c-871e-99b5a9319124
md"""
"Start with a sphere."
"""

# ╔═╡ eb5bbb3a-c2b1-4a4c-ac72-ea4c78ee11c1
(X,Y,Z) = sphere(201);

# ╔═╡ 68b61b35-21e9-4d1f-bfdf-91a22247b92c
md"""
"This computes a vector that is a repeating bump.  We'll multiply this against X,Y,Z to create the dents along the sides of the pumpkin."
"""

# ╔═╡ e214fc8b-b268-4596-aa8b-0f7f3db5e284
R = 1 .- (1 .- mod.(0:0.1:20,2)) .^ 2/15;

# ╔═╡ 81c4123c-63cd-45a8-bcf7-3f5172beddff
md"""
"Multiply X,Y against R for bumps.  Add a dimple to the top/bottom of the pumpkin in addition to making it more squat for Z."
"""

# ╔═╡ 21924064-244e-4732-b405-9d54705e598a
RX = R .* X;

# ╔═╡ b735a6c6-8a29-45f4-8f49-f6caef5c8554
RY = R .* Y;

# ╔═╡ d1abcd85-0f89-4694-8778-93773c39e049
RZ = (0.8 .+ (0 .- (1:-0.01:-1)' .^ 4) * 0.2) .* Z .* R;

# ╔═╡ 61a3573a-a6ee-4a73-bcd4-86a7233cbfd3
md"""
Initialize a scene to draw onto.
"""

# ╔═╡ b7ba7713-b523-454f-ae2a-c4cb6b26888a
scene = Scene(show_axis=false);

# ╔═╡ 6bf474ea-be81-4cf9-804d-1de13aad0219
md"""
Draw the pumpkin with dimples. (Note X,Y flipped).
"""

# ╔═╡ 18819e8a-5070-4b66-b16a-0c2f763564ca
surface!(scene, RX, RY, RZ, color=fill("#ff7518",1,1));

# ╔═╡ ef75f9b4-b438-4ea2-b345-3cb9520f6979
md"""
"For the stem we re-use the sphere matrices, and just translate and scale it into the right spot."
"""

# ╔═╡ c84986bd-132f-4772-94d7-d05e793a7775
surface!(scene, X/12, Y/12, Z/2 .+ 0.4, color=fill("#080",1,1));

# ╔═╡ 7c494ea4-f6a8-4c43-a70a-aff7e160fa21
scene

# ╔═╡ 1c9c572d-039c-43bf-9415-65cdbafb14ce
# display(scene) # use this to display in a pop-up window

# ╔═╡ 2daaa7e2-04a5-4f64-8db8-c099b6f95bfe
md"""
## MATLAB code
