...
# ╔═╡ f0ccfccd-8a40-480a-b535-2ba705fd1357
using PlutoUI, Unitful, LinearAlgebra

# ╔═╡ 9d2384a0-c12c-4271-a473-1cd783bdb938
using GLMakie, GeometryBasics

# ╔═╡ 2d1e4c50-2f8c-11ec-2cf1-e71ab3e6d698
md"""
# Pizza volume = $\operatorname{pi} \cdot z \cdot z \cdot a$
"""

# ╔═╡ b3a1a96d-626a-497f-9b91-4597ec357cb6
LocalResource("img/pizza_meme.jpg")

# ╔═╡ a17af4a9-9ca1-4680-a219-af6a519cd4da
md"""
$$\begin{align}
\operatorname{pi} &= \pi\\
z &= \text{radius}\\
a &= \text{depth}\\
\operatorname{volume} &= \operatorname{pi} \cdot z \cdot z \cdot a \tag{🍕}
\end{align}$$
"""

# ╔═╡ 7e9aaa91-7dea-4354-a9fb-32590f52b208
z = 8u"inch"

# ╔═╡ 86a22928-800e-4b67-a94a-63aeebb8418f
a = 0.5u"inch"

# ╔═╡ 9696ea60-2eba-4bc6-8be7-84d820a43e3c
volume = pi⋅z⋅z⋅a

# ╔═╡ 7d66639e-a2a6-4297-961e-491cdd1256f6
md"""
# Makie the pizza
"""

# ╔═╡ 633c8258-dc67-408d-b099-f3db577fd609
set_theme!(theme_black())

# ╔═╡ 27e2a769-8ddc-4dae-906b-955f73128b4b
r, h = Float64.(ustrip.([z, a]))

# ╔═╡ 74293b2b-4f83-4561-b7e9-cb53ae9a6fe8
🍕 = Cylinder(Point(0.0, 0.0, 0.0), Point(0.0, 0.0, h), r)

# ╔═╡ 6306ac7b-50f2-45bf-bfa8-6c5e9559390b
fig, ax = Makie.mesh(🍕, color=:tomato,
                     axis=(; type=Axis3, limits = (-r, r, -r, r, -r, r)))

# ╔═╡ fd35e005-0bcc-4cc9-bc1a-30c847e8225e
begin
	record(fig, "img/pizza.gif", 1:120) do frame
        ax.azimuth[] = 1.7pi + 0.3 * sin(2pi * frame / 120)
	end
	LocalResource("img/pizza.gif")
end
